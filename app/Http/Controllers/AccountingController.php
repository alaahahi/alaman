...
class AccountingController extends Controller
{
    ...
    { 
        ...
        if($from && $to ){
            ...
            $cars = Car::with('contract')->with('CarImages')->with('exitcar')->where('client_id',$client->id)->whereBetween('date', [$from, $to])->orderBy('date');
            ...
            $cars =  Car::with('contract')->with('CarImages')->with('exitcar')->where('client_id',$client->id)->orderBy('date');
            $car_total = $cars->count();
