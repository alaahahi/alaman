...
function sendWhatsAppMessage(phoneNumber) {
  if(phoneNumber){
    ...
    const message = 'السلام عليكم: شركة الأمان للتجارة ايوب - كركوك ,يرجى الأخذ بالعلم تسديد المبلغ المستحق عليكم في أقرب وقت ممكن. شكرا لتعاونكم  ..........   سڵاوی خواتان لێبێت: کۆمپانیای  الأمان - تکایە ئاگاداربن بە زووترین کات ئەو بڕە پارەیەی کە قەرزارن بیدەن. سوپاس بۆ هەماهەنگیت';
